...
export default function SeparatedCard() {
  return (
<div className="relative w-full h-full flex flex-col lg:flex-row items-center lg:items-start justify-center px-6 py-24 gap-10 lg:py-40" style={{ background: "#f7e7cd" }}>
  ...
  {/* الكارد */}
  <div className="w-full lg:w-1/3 p-7 sm:p-8 rounded-2xl shadow-2xl flex flex-col justify-center text-right lg:ml-30" style={{ background: "#faebd7" }}>
    <h2 className="text-2xl sm:text-3xl font-extrabold text-black">أهلاً انا عمر</h2>
    <p className="text-black text-center  mt-8 sm:mt-4 text-xl sm:text-lg">
