...
export default function SeparatedCard() {
  return (
<div className="relative w-full h-full flex flex-col lg:flex-row items-center lg:items-start justify-center px-6 py-24 gap-10 lg:py-40" style={{ background: "#36688d" }}>
  ...
  {/* الكارد */}
<div className="w-full lg:w-1/3 p-8 flex flex-col items-center text-center rounded-2xl shadow-[8px_8px_0px_#000] border-4 border-black"
